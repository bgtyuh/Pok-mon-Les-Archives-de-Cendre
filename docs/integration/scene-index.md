...
| SCN_TSR_ARRIVAL | docs/narrative/09_script-integral/acte_1/03_transit_sur_rail.md | rom/pokeemerald-expansion/data/maps/TransitSurRail/scripts.inc + rom/pokeemerald-expansion/data/maps/TransitSurRail/map.json | FLAG_SCN_TSR_ARRIVAL_DONE | VAR_CENDRE_STORY_STAGE | IN_PROGRESS | Premiere version jouable de Transit-sur-Rail: scene d'arrivee one-shot + PNJ de hall (avant/apres badge) |
